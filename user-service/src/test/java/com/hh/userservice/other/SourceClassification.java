...
//import com.sjqx.util.HttpWebRequestUtil;
...
//            try {
//                String compress= new HttpWebRequestUtil() {
//                    @Override
//                    public void businessSourceClassify(ConvergePojo resPojo,CountDownLatch countDownLatch,ConvergePojo convergePojo) {
...
//                    }
//                }.sourceClassify(requestView.getJson(),requestView.getToken(),start);
...
//                    }
//                }.sourceClassify(requestView.getJson(),token,start);
//                return ResultView.success(compress);
//            } catch (Exception e) {
