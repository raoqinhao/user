...
import com.hh.userservice.job.QuartzJob;
import com.hh.userservice.job.QuartzJob2;
import org.quartz.*;
...
public class QuartzConfig {
    ...
    public JobDetail printTimeJobDetail(){
        return JobBuilder.newJob(QuartzJob.class)//PrintTimeJob我们的业务类
    ...
    public JobDetail printTimeJobDetail2(){
        return JobBuilder.newJob(QuartzJob2.class)//PrintTimeJob我们的业务类
