layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    tableSelect.prototype.render = function (opt) {
        ...
        opt.parameterKey = opt.parameterKey;
        opt.parameterValue = opt.parameterValue;
        //默认设置
        ...
        opt.table.limits = opt.table.limits || [10, 20, 30, 40, 50, 60, 70, 80, 90];
        ...
        elem.off('click').on('click', function (e) {
            ...
            tableBox += '<input type="hidden" name="' + opt.parameterKey + '" value="' + opt.parameterValue + '">';
